      ...
      <div className="container-site py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex items-start gap-3">
            <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-navy-900 text-white">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a
                href={site.emailHref}
                className="break-all text-slate-600 hover:text-navy-900"
              >
                {site.email}
              </a>
            </div>
          ...
          <div className="flex items-start gap-3 md:col-span-2">
            ...
            <div>
              <p className="text-sm font-semibold text-navy-950">Address</p>
